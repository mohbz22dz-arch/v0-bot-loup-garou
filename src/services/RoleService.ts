...
export class RoleService {
  ...
  private readonly roleDescriptions: Record<Role, RoleDescription> = {
    'Loup-Garou': {
      name: 'Loup-Garou',
  ...
  async assignRoles(
    ...
    try {
      ...
      const assignments: Array<{ playerId: string; role: Role; userId: string }> = [];
  ...
  private generateRoleReport(assignments: Array<{ playerId: string; role: Role; userId: string }>): string {
